...
public class CPU implements Runnable {
	...
	//public Queue<Process> RRQ = new LinkedList<Process>();
	public List<Process> list = new ArrayList<Process>();

	File file1 = new File("C:\\Users\\Weydson\\Java-Study\\OS Simulation Facul\\src\\program1.txt");
	File file2 = new File("C:\\Users\\Weydson\\Java-Study\\OS Simulation Facul\\src\\program2.txt");
	...
	private void createThread(int line) {
	...
	public void criarProcessos() {
		Process init = new Process(0, "init", ProcessState.RUNNING, 0, timeRun, 0);
		Process pc1 = new Process(1, "pc1", ProcessState.RUNNING, 0, timeRun+3, init.getId());
		Process pc2 = new Process(2, "pc2", ProcessState.RUNNING, 0, timeRun+5, init.getId());
		init.addProcessoFilho(pc1);
	...
	public void getProcs() {
		...
		for (Process o: list) {
			System.out.println(o.getState() + "\t\t" + o.getProcessoPai() + "\t\t" + o.getProcessosFilho() + "\t\t" + o.getId() 
			+ "\t\t" + (timeRun - o.getTime()));
		}
	}
